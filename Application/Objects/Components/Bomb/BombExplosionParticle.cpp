...
namespace KashipanEngine {
    ...
    BombExplosionParticle::BombExplosionParticle(const ParticleConfig& config)
    ...
    std::optional<bool> BombExplosionParticle::Initialize() {
    ...
    std::optional<bool> BombExplosionParticle::Update() {
    ...
    void BombExplosionParticle::Spawn(const Vector3& position) {
    ...
    bool BombExplosionParticle::IsAlive() const {
        return isAlive_;
    }

#if defined(USE_IMGUI)
    void BombExplosionParticle::ShowImGui() {
