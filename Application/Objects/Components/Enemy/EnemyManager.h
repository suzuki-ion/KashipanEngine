...
namespace KashipanEngine {
    ...
    public:
        ...
        void SetWallBreak(WallBreakParticleManager* mana) { wallBreakParticle_ = mana; }
    ...
    private:
        ...
        ScoreManager* scoreManager_ = nullptr;  // スコアマネージャー
        ScoreDisplay* scoreDisplay_ = nullptr;  // スコア表示
        WallBreakParticleManager* wallBreakParticle_ = nullptr;
