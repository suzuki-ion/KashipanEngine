...
void EnemyManager::Update() {
    ...
    for (auto& e : activeEnemies_) {
        ...
        Vector3 nextPos = Vector3(Eased(e.startPosition, e.targetPosition, bpmProgress_, EaseType::EaseOutQuint));
        float currentPosY = float(EasedGAB(0.0f, 0.5f, bpmProgress_, EaseType::EaseOutCirc, EaseType::EaseInCirc));
