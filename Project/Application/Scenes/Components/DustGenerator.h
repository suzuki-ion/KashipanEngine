...
namespace KashipanEngine {
    ...
    class DustGenerator final : public ISceneComponent {
    public:
        struct Runtime {
        ...
        DustGenerator() : ISceneComponent("DustGenerator", 1) {}
        ~DustGenerator() override = default;
    ...
    private:
        ...
        void Respawn(Runtime& runtime) {
			...
			// Spawn位置はプレイヤーの進行方向に対してランダムな半径で円状に広がるようにする
            const float radius = GetRandomValue(0.0f, 180.0f);
        ...
        float recycleBehindDistance_ = 248.0f;
