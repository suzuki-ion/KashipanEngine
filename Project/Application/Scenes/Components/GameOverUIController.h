...
class GameOverUIController final : public ISceneComponent {
public:
    ...
    GameOverUIController()
        : ISceneComponent("GameOverUIController", 1) {}

    ~GameOverUIController() override = default;
    ...
    void Initialize() override {
        ...
        retry->SetName("GameOverRetryText");
        ...
        backTitle->SetName("GameOverBackToTitleText");
...
private:
    ...
    void cacheTextTransforms() {
        std::array<Text *, 4> texts = {logoText_, retryText_, backToTitleText_, quitText_};
    ...
    void updateVerticalBobbing() {
        ...
        apply(retryText_, 1, selectionIndex_ == 0);
        apply(backToTitleText_, 2, selectionIndex_ == 1);
        apply(quitText_, 3, selectionIndex_ == 2);
    }
...
private:
    ...
    std::array<Vector3, 4> basePositions_{};
    std::array<Vector3, 4> startPositions_{};
};
