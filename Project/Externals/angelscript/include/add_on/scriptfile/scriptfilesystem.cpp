...
void RegisterScriptFileSystem_Native(asIScriptEngine *engine)
{
	...
	r = engine->RegisterObjectMethod("filesystem", "int deleteFile(const string &in)", asSMethodPtr<sizeof(void (CScriptFileSystem:: *)())>::Convert((void (CScriptFileSystem:: *)())(&CScriptFileSystem::DeleteFile)), asCALL_THISCALL); assert(r >= 0);
