...
inline constexpr const Matrix4x4 Matrix4x4::operator+(const Matrix4x4 &matrix) const noexcept {
...
inline constexpr const Matrix4x4 Matrix4x4::operator*(const float scalar) const noexcept {
    // 少しでも速度を稼ぐためにループではなく展開する
    return Matrix4x4(
