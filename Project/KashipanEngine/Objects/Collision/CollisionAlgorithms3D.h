...
namespace {
inline float Clamp(float v, float mn, float mx) { LogScope scope; return std::clamp(v, mn, mx); }
...
inline bool Intersects(const Math::Point3D &p, const Math::Sphere &s) { LogScope scope; return Intersects(s, p); }
...
inline bool Intersects(const Math::Point3D &p, const Math::AABB &b) { LogScope scope; return Intersects(b, p); }
...
inline bool Intersects(const Math::AABB &b, const Math::Sphere &s) { LogScope scope; return Intersects(s, b); }
...
inline bool Intersects(const Math::Point3D &p, const Math::Plane &pl, float thickness = 0.0f) { LogScope scope; return Intersects(pl, p, thickness); }
...
inline bool Intersects(const Math::Sphere &s, const Math::Plane &pl) { LogScope scope; return Intersects(pl, s); }
...
inline bool Intersects(const Math::Point3D &p, const Math::OBB &b) { LogScope scope; return Intersects(b, p); }
...
inline bool Intersects(const Math::Sphere &s, const Math::OBB &b) { LogScope scope; return Intersects(b, s); }
